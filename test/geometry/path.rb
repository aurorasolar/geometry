...
describe Geometry::Path do
  describe "construction" do
    it "must create a Path with no arguments" do
      ...
      _(path).must_be_kind_of Geometry::Path
      _(path.elements).wont_be_nil
      _(path.elements.size).must_equal 0
    end

    it "must create a Path from Points" do
      path = Geometry::Path.new Point[1,1], Point[2,2], Point[3,3]
      _(path.elements.size).must_equal 2
      path.elements.each {|a| _(a).must_be_kind_of Geometry::Edge }
    end
    ...
    it "with disjoint Edges" do
      ...
      _(path.elements.size).must_equal 3
      path.elements.each {|a| _(a).must_be_kind_of Geometry::Edge }
    end
    ...
    it "with Points and Arcs" do
      ...
      _(path.elements.size).must_equal 3
      _(path.elements[0]).must_be_kind_of Geometry::Edge
      _(path.elements[1]).must_be_kind_of Geometry::Arc
      _(path.elements[2]).must_be_kind_of Geometry::Edge
    end
    ...
    it "with disjoint Edges and Arcs" do
      ...
      _(path.elements.size).must_equal 4
      _(path.elements[0]).must_be_kind_of Geometry::Edge
      _(path.elements[1]).must_be_kind_of Geometry::Edge
      _(path.elements[2]).must_be_kind_of Geometry::Arc
      _(path.elements[3]).must_be_kind_of Geometry::Edge
    end
    ...
    it "with disjoint Arcs" do
      ...
      _(path.elements.size).must_equal 3
      _(path.elements[0]).must_be_kind_of Geometry::Arc
      _(path.elements[1]).must_be_kind_of Geometry::Edge
      _(path.elements[2]).must_be_kind_of Geometry::Arc

      _(path.elements[0].last).must_equal path.elements[1].first
    end
  end
end
